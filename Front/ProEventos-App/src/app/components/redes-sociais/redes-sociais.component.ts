...
import { RedeSocialService } from 'src/services/RedeSocial.service';
...
export class RedesSociaisComponent implements OnInit {
  ...
  public get redeSocialValid(): boolean{
    return this.formRS.controls["redesSociais"].valid ? true : false
  }
  ...
  public validation(): void {
    ...
    this.formRS.controls['redesSociais'].valid;
  }
